    ...
    <nav className="w-full bg-white pt-[14px] pb-[14px]">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between px-4 lg:px-0">
        <div className="hidden md:flex gap-8 ml-3">
          ...
          <Link href="/" className="text-[#007580] font-medium">
            Shop
          </Link>
          <Link href="/ProductPage" className="text-[#007580] font-medium">
            Product
          </Link>
          <Link href="/Pages" className="text-[#007580] font-medium">
            Pages
          </Link>
          <Link href="/About" className="text-[#007580] font-medium">
            About
          </Link>
        </div>
      ...
      {isMenuOpen && (
        <div className="lg:hidden flex flex-col gap-4 mt-4 px-4">
          ...
          <Link href="/ProductPage" className="text-[14px] font-medium">
            Product
          </Link>
